...
load("/Users/fdzul/Dropbox/r_developments/r_packages/private/denmex/data/eggs_betas_14_jalisco.rda")
source("/Users/fdzul/Dropbox/r_developments/r_talks/2023/reunion_interstatal_2023/reunion_quintana_roo/functions/intensity_eggs.R")

eggs_betas_14_jalisco |>
    dplyr::filter(year == 2019) |>
...
# Step 1. calculate the risk ####
load("/Users/fdzul/Dropbox/r_developments/r_packages/private/denmex/data/eggs_betas_14_jalisco.rda")
risk <- denhotspots::risk_ageb(betas = eggs_betas_14_jalisco,
                               hotspots = denmex::den_hotspots,
                               intensity_perc = 25,
                               locality = c("Guadalajara",
                                              "Tlaquepaque",
...
Concepto
<img src = "https://github.com/fdzul/spatial_analysis_dengue_R_2024_talks/blob/main/talks/spatial_analysis_dengue/fig/stacked_maps_cases.jpg?raw=true">
:::
...
::: {.column style="width: 40%;font-size: 70%"}
<span style="color:#F44B1FFF;">Áreas de Riesgo.</span> Área de mayor concentración de casos + mayor abundancias del vector.
