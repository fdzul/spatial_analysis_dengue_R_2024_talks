...
DiagrammeR::grViz("digraph {
  ...
  cadenas [label = 'Cadenas de Transmisión',  fillcolor = '#DB4437', color = 'white', fontcolor = 'black']
  node [shape = circle, style = filled, color = grey] 
  
  heatmap [label = 'Mapas de Calor',  fillcolor = '#DB4437', color = 'white', fontcolor = 'black']
  node [shape = circle, style = filled, color = grey] 
