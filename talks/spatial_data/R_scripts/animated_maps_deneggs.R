...
library(magrittr)
deneggs::animap_vector_hotblocks(path_vector = "/Users/fdzul/Library/CloudStorage/OneDrive-Personal/datasets/CENAPRECE/2022/31_yucatan",
                                 cve_edo = "31",
                                 locality = "Merida",
...
deneggs::animap_vector_hotblocks(path_vector = "/Users/fdzul/Library/CloudStorage/OneDrive-Personal/datasets/CENAPRECE/2023/31_yucatan",
                                 cve_edo = "31",
                                 locality = "Merida",
                                 dir = "talks/spatial_data",
                                 name = "merida_2023",
...
tmap::tmap_animation(animated_map,
                     delay = vel,
                     filename = "talks/spatial_data/31_merida_hotblocks_2023.gif")

magick::image_read("talks/spatial_data/31_merida_hotblocks_2023.gif")
