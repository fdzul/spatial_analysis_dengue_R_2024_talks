...
```{r echo=FALSE}
tibble::tibble(argumentos = c("path_lect", "path_coord", 
                              "locality",  "cve_ent", 
                              "longitude", "latitude",
                              "year", "week o sem", 
                              "var", "plot", "k"),
...
```{r echo=FALSE}
tibble::tibble(argumentos = c("fam", 
...
## [Argumentos de la función [deneggs::eggs_hotspots]()]{.r-fit-text style="color:#003300;"}
<hr style="height:2px;border-width:0;color:#330019;background-color:#330019">
...
## [Argumentos de la función [deneggs::spde_pred_map]()]{.r-fit-text style="color:#003300;"}
<hr style="height:2px;border-width:0;color:#330019;background-color:#330019">
